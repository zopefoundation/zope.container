#!/usr/bin/env python3
#
# zope.container documentation build configuration file, created by
...
htmlhelp_basename = 'zopecontainerdoc'
...
latex_documents = [
    ('index', 'zopecontainer.tex', 'zope.container Documentation',
...
extlinks = {
    'issue': (
        'https://github.com/zopefoundation/zope.container/issues/%s',
        'issue #'),
    'pr': (
        'https://github.com/zopefoundation/zope.container/pull/%s',
        'pull request #')}
